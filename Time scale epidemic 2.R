...
avg=function(N,r,n){
  ...
  m=t(matrix(l,c(200,100)))
  return(colSums(m)/100)
}



plot(c(0,200),c(0,0.9),type="n",xlab = "Time",ylab = "Prevalence",cex.lab=1.5,
     cex.axis=1.5,main = "",cex.main=1.5)
 v1=avg(200,0.07,1)
...
plot(c(0,150),c(0,0.7),type="n",xlab = "Time",ylab = "Prevalence",cex.lab=1.5,
     cex.axis=1.5,main = "N = 200, b = 0.04",cex.main=1.5)
v1=avg(200,0.04,1)
lines(1:150,v1[1:150],col="blue",lwd=1.5)
# lines(1:200,avg(200,0.07,2),col="red",lwd=2)
# lines(1:200,avg(200,0.07,3),col="green",lwd=2)
# lines(1:200,avg(100,0.07,4),col="brown",lwd=2)
v2=avg(200,0.04,5)
lines(1:150,v2[1:150],col="green",lwd=1.5)
v3=avg(200,0.04,10)
lines(1:150,v3[1:150],col="orange",lwd=1.5)
v4=avg(200,0.05,15)
lines(1:150,v4[1:150],col="red",lwd=1.5)
v5=avg(200,0.04,20)
lines(1:150,v5[1:150],col="black",lwd=1.5)
v6=avg(200,0.04,30)
lines(1:150,v6[1:150],col="violet",lwd=1.5)
v7=avg(200,0.04,40)
lines(1:150,v7[1:150],col="brown3",lwd=1.5)
v8=avg(200,0.04,50)
lines(1:150,v8[1:150],col="gray",lwd=1.5)
v9=avg(200,0.04,100)
lines(1:150,v9[1:150],col="cyan3",lwd=1.5)
...
legend(125, 0.8, legend=c("1", "5","10","15","20","30","40","50","100"),
       col=c("blue", "green","orange","red","black","violet","brown3","gray",
             "cyan3"), lty=1,lwd=2, cex=1.,title = "Time Scale")
legend(125, 0.6, legend=c("1", "5","10"),
       col=c("blue", "green","orange"), lty=1,lwd=2, cex=1.2,title = "Time Scale")

plot(c(0,150),c(0,0.5),type="n",xlab = "Time",ylab = "Prevalence",cex.lab=1.5,
     cex.axis=1.5,main = "N = 200, b = 0.03",cex.main=1.5)
v1=avg(200,0.03,1)
lines(1:150,v1[1:150],col="blue",lwd=1.5)
# lines(1:200,avg(200,0.07,2),col="red",lwd=2)
# lines(1:200,avg(200,0.07,3),col="green",lwd=2)
